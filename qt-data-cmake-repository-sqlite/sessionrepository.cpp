...
SessionRepository::SessionRepository(const std::shared_ptr<UserRepository> userRepository, const QString dbName) {
    this->dbName = dbName;
...
std::optional<int> SessionRepository::create(int userId, const QString &code) {
...
std::optional<int> SessionRepository::getIdByCode(const QString &sessionCode) {
    auto db = QSqlDatabase::database(dbName);
